...
export const UPModal = ({ visible, onCancel, onOk, resources,setvisible,loading }) => {
  ...
  const title = (
    <div style={{ display: 'flex', justifyContent: 'center', gap: "5px" }}>
      <Update />
      <Text>{t("Update Resource Update Priority")}</Text>
    </div>
  )

  const message = `Enter the UP of gamservers ${resourceNames.join(', ')} to which you want to update.`;
